...
\resumeItemListStart
\resumeItem{Revamped development and CI/CD workflows by restructuring and introducing cutting-edge technologies such as Development Containers leading to a robust and streamlined operational process.}
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
	      \begin{tabbing}
		      ...
		      \>{Helm, MapBox, Open3D, OpenCV, PyTorch, React, REST APIs, SpringBoot, VIM} \\
