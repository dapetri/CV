...
% Some definition of functions overlap
\let\Cross\relax
...
{\textbf{Machine Learning / Software Engineer}}{03/2024 -- present}
\resumeItemListStart
\resumeItem{Industrializing a CLIP-LLM-based meat classification system and a foreign object detection system for Kaufland meat factories.}
...
\resumeItem{Revamped development and CI/CD workflows by restructuring and introducing modern technologies such as Development Containers leading to a robust and streamlined operational process.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Successfully piloted and deployed a ResNet embedding-based anomaly detection algorithm (PatchCore), identifying 87\% of production errors in V8 engine blocks and reducing the error slippage to below 5\%.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Conducted a comparative analysis of clustering algorithms across Python, R, and Matlab. Identified significant performance differences between the platforms, e.g., 20\% variance in clustering stability between languages and up to 10x difference in runtime.}
\resumeItemListEnd
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
	      \begin{tabbing}
		      ...
		      \textbf{Tools} \> {Docker, Kubernetes/Helm, ArgoCD/Rancher, Azure/GitHub CI/CD,} \\
		       \> {PyTorch, OpenCV, REST APIs, Linux} \\
